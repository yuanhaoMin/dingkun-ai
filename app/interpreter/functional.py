...
# from app.interpreter.jupyter_backend import delete_color_control_char
#
#
...
#
#     assert config["model"][model_choice][
#         "available"
#     ], f"{model_choice} is not available for you API key"
#
...
#     """
#     GPT可能会生成非标准的JSON格式字符串，字符串值中包含'\n'，这会导致使用`json.loads()`时出错
#     这个解析器，从非标准的JSON字符串中直接提取代码
#     :return: 如果成功解析则返回代码字符串，否则返回None
#     """
#     parser_log = {
#         "met_begin_{": False,
#         'begin_"code"': False,
...
#                 else:
#                     continue
#             code_str = function_args[
#                 parser_log["code_begin_index"] : parser_log["code_end_index"] + 1
#             ]
#             if "\n" in code_str:
